...
public class CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator implements com.sencha.gxt.core.client.resources.CommonStyles.CommonStylesDefaultAppearance.CommonDefaultResources {
  private static CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator _instance0 = new CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator();
  ...
  private void stylesInitializer() {
    styles = new com.sencha.gxt.core.client.resources.CommonStyles.CommonStylesDefaultAppearance.CommonDefaultStyles() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOKTVRVBGL,.GOKTVRVBGL:focus{outline:" + ("none")  + ";}.GOKTVRVBJL{position:" + ("absolute")  + " !important;right:" + ("0")  + ";top:" + ("0")  + ";}.GOKTVRVBBL{display:" + ("none")  + " !important;}.GOKTVRVBCL{position:" + ("absolute")  + " !important;right:" + ("-10000px")  + " !important;top:" + ("-10000px")  + " !important;visibility:" + ("hidden")  + " !important;}.GOKTVRVBDL{visibility:" + ("hidden")  + " !important;}.GOKTVRVBML,.GOKTVRVBML *{-moz-user-select:") + (("none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("none")  + ";}.GOKTVRVBNL{-moz-user-select:" + ("-moz-none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("none")  + ";}.x-clear{clear:" + ("both")  + ";overflow:" + ("hidden")  + ";line-height:" + ("0")  + ";font-size:" + ("0")  + ";}.GOKTVRVBPK{float:" + ("right") ) + (";}.GOKTVRVBAL{float:" + ("left")  + ";}.GOKTVRVBNK{cursor:" + ("w-resize")  + ";cursor:" + ("col-resize")  + ";}.GOKTVRVBOK{cursor:" + ("n-resize")  + ";cursor:" + ("row-resize")  + ";}.GOKTVRVBFL{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}.GOKTVRVBIL{white-space:" + ("nowrap")  + ";}.GOKTVRVBLL{height:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getHeight() + "px")  + ";width:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getSafeUri().asString() + "\") -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getLeft() + "px -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getTop() + "px  no-repeat")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";display:" + ("none")  + ";position:" + ("absolute")  + ";right:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("20000")  + ";}")) : ((".GOKTVRVBGL,.GOKTVRVBGL:focus{outline:" + ("none")  + ";}.GOKTVRVBJL{position:" + ("absolute")  + " !important;left:" + ("0")  + ";top:" + ("0")  + ";}.GOKTVRVBBL{display:" + ("none")  + " !important;}.GOKTVRVBCL{position:" + ("absolute")  + " !important;left:" + ("-10000px")  + " !important;top:" + ("-10000px")  + " !important;visibility:" + ("hidden")  + " !important;}.GOKTVRVBDL{visibility:" + ("hidden")  + " !important;}.GOKTVRVBML,.GOKTVRVBML *{-moz-user-select:") + (("none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("none")  + ";}.GOKTVRVBNL{-moz-user-select:" + ("-moz-none")  + ";-khtml-user-select:" + ("none")  + ";-webkit-user-select:" + ("none")  + ";}.x-clear{clear:" + ("both")  + ";overflow:" + ("hidden")  + ";line-height:" + ("0")  + ";font-size:" + ("0")  + ";}.GOKTVRVBPK{float:" + ("left") ) + (";}.GOKTVRVBAL{float:" + ("right")  + ";}.GOKTVRVBNK{cursor:" + ("e-resize")  + ";cursor:" + ("col-resize")  + ";}.GOKTVRVBOK{cursor:" + ("n-resize")  + ";cursor:" + ("row-resize")  + ";}.GOKTVRVBFL{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}.GOKTVRVBIL{white-space:" + ("nowrap")  + ";}.GOKTVRVBLL{height:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getHeight() + "px")  + ";width:" + ((CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getSafeUri().asString() + "\") -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getLeft() + "px -" + (CommonStyles_CommonStylesDefaultAppearance_CommonDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.shim()).getTop() + "px  no-repeat")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";display:" + ("none")  + ";position:" + ("absolute")  + ";left:" + ("0")  + ";top:" + ("0")  + ";z-index:" + ("20000")  + ";}"));
      }
