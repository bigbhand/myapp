...
public class TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.TriggerFieldDefaultAppearance.TriggerFieldResources {
  private static TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator _instance0 = new TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator();
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.field.TriggerFieldDefaultAppearance.TriggerFieldStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (("input.GOKTVRVBC-,textarea.GOKTVRVBC-{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GOKTVRVBD-,textarea.GOKTVRVBD-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GOKTVRVBJ-{position:" + ("relative")  + ";right:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("right")  + ";}.GOKTVRVBA-{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBPY{color:" + ("gray")  + ";}.GOKTVRVBH-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto") ) + (";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GOKTVRVBNY{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:") + (("none")  + ";overflow:" + ("visible")  + ";padding:" + ("0")  + ";margin:" + ("0")  + ";}.GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";border-bottom-color:" + ("#b5b8c8") ) + (";}.GOKTVRVBC- .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBF- .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getTop() + "px  no-repeat")  + ";height:") + (("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBOY .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBE-{cursor:" + ("pointer")  + ";}")) : (("input.GOKTVRVBC-,textarea.GOKTVRVBC-{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GOKTVRVBD-,textarea.GOKTVRVBD-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GOKTVRVBJ-{position:" + ("relative")  + ";left:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("left")  + ";}.GOKTVRVBA-{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBPY{color:" + ("gray")  + ";}.GOKTVRVBH-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto") ) + (";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GOKTVRVBNY{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:") + (("none")  + ";overflow:" + ("visible")  + ";padding:" + ("0")  + ";margin:" + ("0")  + ";}.GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrow()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom:" + ("1px"+ " " +"solid")  + ";border-bottom-color:" + ("#b5b8c8") ) + (";}.GOKTVRVBC- .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowFocus()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBF- .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowOver()).getTop() + "px  no-repeat")  + ";height:") + (("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBOY .GOKTVRVBI-{height:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getHeight() + "px")  + ";width:" + ((TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getSafeUri().asString() + "\") -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getLeft() + "px -" + (TriggerFieldDefaultAppearance_TriggerFieldResources_gecko1_8_de_InlineClientBundleGenerator.this.triggerArrowClick()).getTop() + "px  no-repeat")  + ";height:" + ("21px")  + ";border-bottom-color:" + ("#7eadd9")  + ";}.GOKTVRVBE-{cursor:" + ("pointer")  + ";}"));
      }
