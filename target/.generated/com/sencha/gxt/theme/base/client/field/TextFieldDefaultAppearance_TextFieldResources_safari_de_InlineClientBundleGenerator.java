...
public class TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.TextFieldDefaultAppearance.TextFieldResources {
  private static TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator _instance0 = new TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator();
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.field.TextFieldDefaultAppearance.TextFieldStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (("input.GOKTVRVBIY,textarea.GOKTVRVBIY{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GOKTVRVBJY,textarea.GOKTVRVBJY{height:" + ((TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GOKTVRVBMY{position:" + ("relative")  + ";right:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("right")  + ";}.GOKTVRVBGY{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBFY{color:" + ("gray")  + ";}.GOKTVRVBLY{height:" + ((TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto") ) + (";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GOKTVRVBEY{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:") + (("none")  + ";overflow:" + ("visible")  + ";}")) : (("input.GOKTVRVBIY,textarea.GOKTVRVBIY{border:" + ("1px"+ " " +"solid"+ " " +"#7eadd9")  + ";}input.GOKTVRVBJY,textarea.GOKTVRVBJY{height:" + ((TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getSafeUri().asString() + "\") -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getLeft() + "px -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.invalidLine()).getTop() + "px  repeat-x")  + ";background-color:" + ("#fff")  + ";background-position:" + ("bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#c30")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";}.GOKTVRVBMY{position:" + ("relative")  + ";left:") + (("0")  + ";top:" + ("0")  + ";zoom:" + ("1")  + ";white-space:" + ("nowrap")  + ";text-align:" + ("left")  + ";}.GOKTVRVBGY{font:" + ("12px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBFY{color:" + ("gray")  + ";}.GOKTVRVBLY{height:" + ((TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getSafeUri().asString() + "\") -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getLeft() + "px -" + (TextFieldDefaultAppearance_TextFieldResources_safari_de_InlineClientBundleGenerator.this.textBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto") ) + (";background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:" + ("none")  + ";height:" + ("18px")  + ";line-height:" + ("18px")  + ";vertical-align:" + ("top")  + ";}.GOKTVRVBEY{background-color:" + ("#fff")  + ";border:" + ("1px"+ " " +"#b5b8c8"+ " " +"solid")  + ";padding:" + ("1px"+ " " +"3px")  + ";resize:") + (("none")  + ";overflow:" + ("visible")  + ";}"));
      }
