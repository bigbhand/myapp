...
public class ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.button.ButtonCellDefaultAppearance.ButtonCellResources {
  private static ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator _instance0 = new ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.button.ButtonCellDefaultAppearance.ButtonCellStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOKTVRVBMN{cursor:" + ("pointer")  + ";white-space:" + ("nowrap")  + ";}.GOKTVRVBNN .GOKTVRVBEO{width:" + ("100%")  + ";}.GOKTVRVBMN td{text-align:" + ("center")  + ";}.GOKTVRVBMN td img{float:" + ("right")  + ";}.GOKTVRVBBO td img,.GOKTVRVBON td img{float:" + ("none")  + ";}.GOKTVRVBCO{padding:" + ("0"+ " " +"2px")  + ";}.GOKTVRVBLO{padding:" + ("0"+ " " +"2px")  + ";font-family:" + ("Tahoma"+ ","+ " " +"Arial"+ ","+ " " +"Verdana"+ ","+ " " +"sans-serif")  + ";font-size:" + ("11px")  + ";font-weight:") + (("normal")  + ";text-align:" + ("center")  + ";cursor:" + ("pointer")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";}.GOKTVRVBCO div{font-size:" + ("1px")  + ";}.GOKTVRVBIO .GOKTVRVBPN td,.GOKTVRVBIO .GOKTVRVBAO td,.GOKTVRVBIO .GOKTVRVBGO td{line-height:" + ("18px")  + ";}.GOKTVRVBFO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBFO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("20px")  + ";}.GOKTVRVBFO .GOKTVRVBPN td,.GOKTVRVBFO .GOKTVRVBAO td,.GOKTVRVBFO .GOKTVRVBGO td{line-height:" + ("24px")  + ";}.GOKTVRVBFO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBFO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("26px")  + ";}.GOKTVRVBDO .GOKTVRVBPN td,.GOKTVRVBDO .GOKTVRVBAO td,.GOKTVRVBDO .GOKTVRVBGO td,.GOKTVRVBDO .GOKTVRVBCO div{line-height:" + ("32px") ) + (";}.GOKTVRVBDO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBDO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("34px")  + ";}.GOKTVRVBJO{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("left"+ " " +"center")  + ";padding-left:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBKO{height:") + (((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";gwt-image:" + ("\"splitBottom\"")  + ";background-position:" + ("center"+ " " +"bottom")  + ";padding-bottom:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBKN{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getHeight() + "px") ) + (";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";padding-left:" + ("10px")  + ";background-position:" + ("left"+ " " +"center")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBLN{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("center"+ " " +"bottom")  + ";padding-bottom:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}")) : ((".GOKTVRVBMN{cursor:" + ("pointer")  + ";white-space:" + ("nowrap")  + ";}.GOKTVRVBNN .GOKTVRVBEO{width:" + ("100%")  + ";}.GOKTVRVBMN td{text-align:" + ("center")  + ";}.GOKTVRVBMN td img{float:" + ("left")  + ";}.GOKTVRVBBO td img,.GOKTVRVBON td img{float:" + ("none")  + ";}.GOKTVRVBCO{padding:" + ("0"+ " " +"2px")  + ";}.GOKTVRVBLO{padding:" + ("0"+ " " +"2px")  + ";font-family:" + ("Tahoma"+ ","+ " " +"Arial"+ ","+ " " +"Verdana"+ ","+ " " +"sans-serif")  + ";font-size:" + ("11px")  + ";font-weight:") + (("normal")  + ";text-align:" + ("center")  + ";cursor:" + ("pointer")  + ";white-space:" + ("nowrap")  + ";overflow:" + ("hidden")  + ";}.GOKTVRVBCO div{font-size:" + ("1px")  + ";}.GOKTVRVBIO .GOKTVRVBPN td,.GOKTVRVBIO .GOKTVRVBAO td,.GOKTVRVBIO .GOKTVRVBGO td{line-height:" + ("18px")  + ";}.GOKTVRVBFO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBFO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("20px")  + ";}.GOKTVRVBFO .GOKTVRVBPN td,.GOKTVRVBFO .GOKTVRVBAO td,.GOKTVRVBFO .GOKTVRVBGO td{line-height:" + ("24px")  + ";}.GOKTVRVBFO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBFO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("26px")  + ";}.GOKTVRVBDO .GOKTVRVBPN td,.GOKTVRVBDO .GOKTVRVBAO td,.GOKTVRVBDO .GOKTVRVBGO td,.GOKTVRVBDO .GOKTVRVBCO div{line-height:" + ("32px") ) + (";}.GOKTVRVBDO .GOKTVRVBBO .GOKTVRVBCO div,.GOKTVRVBDO .GOKTVRVBON .GOKTVRVBCO div{height:" + ("34px")  + ";}.GOKTVRVBJO{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.split()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("right"+ " " +"center")  + ";padding-right:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBKO{height:") + (((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.splitBottom()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";gwt-image:" + ("\"splitBottom\"")  + ";background-position:" + ("center"+ " " +"bottom")  + ";padding-bottom:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBKN{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getHeight() + "px") ) + (";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrow()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";padding-right:" + ("10px")  + ";background-position:" + ("right"+ " " +"center")  + ";background-repeat:" + ("no-repeat")  + ";}.GOKTVRVBLN{height:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getHeight() + "px")  + ";width:" + ((ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getSafeUri().asString() + "\") -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getLeft() + "px -" + (ButtonCellDefaultAppearance_ButtonCellResources_safari_de_InlineClientBundleGenerator.this.arrowBottom()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-position:" + ("center"+ " " +"bottom")  + ";padding-bottom:" + ("14px")  + ";background-repeat:" + ("no-repeat")  + ";}"));
      }
