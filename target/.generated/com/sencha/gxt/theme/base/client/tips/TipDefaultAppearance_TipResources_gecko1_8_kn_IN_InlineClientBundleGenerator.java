...
public class TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.tips.TipDefaultAppearance.TipResources {
  private static TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator _instance0 = new TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tips.TipDefaultAppearance.TipStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOKTVRVBNLB{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GOKTVRVBOLB{float:" + ("left")  + ";}.GOKTVRVBLLB{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBMLB{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBHLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GOKTVRVBJLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GOKTVRVBILB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GOKTVRVBKLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}")) : ((".GOKTVRVBNLB{padding:" + ("2px")  + ";font-size:" + ("12px")  + ";}.GOKTVRVBOLB{float:" + ("right")  + ";}.GOKTVRVBLLB{color:" + ("#444")  + ";font:" + ("bold"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBMLB{color:" + ("#444")  + ";font:" + ("11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GOKTVRVBHLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorBottom()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GOKTVRVBJLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorRight()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}.GOKTVRVBILB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorLeft()).getTop() + "px  no-repeat") ) + (";position:" + ("absolute")  + ";}.GOKTVRVBKLB{height:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getLeft() + "px -" + (TipDefaultAppearance_TipResources_gecko1_8_kn_IN_InlineClientBundleGenerator.this.anchorTop()).getTop() + "px  no-repeat")  + ";position:" + ("absolute")  + ";}"));
      }
