...
public class ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.field.ErrorTipDefaultAppearance.ErrorTipFrameResources {
  private static ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator _instance0 = new ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.field.ErrorTipDefaultAppearance.ErrorTipNestedDivFrameStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOKTVRVBGT{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GOKTVRVBFT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBMT{height:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-right:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBLT{height:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GOKTVRVBNT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-left:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GOKTVRVBDT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-right:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBCT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBET{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"bottom")  + ";padding-left:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBHT{width:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-right:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBKT{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("left"+ " " +"0")  + ";padding-left:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBFT{background-color:" + ("white")  + ";}.GOKTVRVBDT{background-repeat:" + ("no-repeat")  + ";}")) : ((".GOKTVRVBGT{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GOKTVRVBFT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBMT{height:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-left:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBLT{height:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GOKTVRVBNT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-right:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GOKTVRVBDT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-left:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBCT{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBET{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"bottom")  + ";padding-right:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBHT{width:" + ((ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-left:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBKT{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (ErrorTipDefaultAppearance_ErrorTipFrameResources_hi_IN_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("right"+ " " +"0")  + ";padding-right:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBFT{background-color:" + ("white")  + ";}.GOKTVRVBDT{background-repeat:" + ("no-repeat")  + ";}"));
      }
