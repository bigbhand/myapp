...
public class ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.listview.ListViewDefaultAppearance.ListViewDefaultResources {
  private static ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator _instance0 = new ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator();
  private void cssInitializer() {
    css = new com.sencha.gxt.theme.base.client.listview.ListViewDefaultAppearance.ListViewDefaultStyle() {
      ...
      public String getText() {
        return (".GOKTVRVBLCB{background-color:" + ("white")  + ";border:" + ("1px"+ " " +"solid"+ " " +com.sencha.gxt.core.client.resources.ThemeStyles.get().borderColor())  + ";-moz-outline:" + ("none")  + ";outline:" + ("0"+ " " +"none")  + ";position:" + ("relative")  + ";overflow-y:" + ("auto")  + ";}.GOKTVRVBICB{border:" + ("1px"+ " " +"solid"+ " " +"#fff")  + ";font-family:" + ("tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";font-size:" + ("12px")  + ";font-size-adjust:" + ("none")  + ";font-stretch:") + (("normal")  + ";font-style:" + ("normal")  + ";font-variant:" + ("normal")  + ";font-weight:" + ("normal")  + ";line-height:" + ("normal")  + ";overflow:" + ("hidden")  + ";text-overflow:" + ("ellipsis")  + ";padding:" + ("2px")  + ";white-space:" + ("nowrap")  + ";cursor:" + ("pointer")  + ";}.GOKTVRVBJCB{height:" + ((ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.selectedBackground()).getHeight() + "px") ) + (";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.selectedBackground()).getSafeUri().asString() + "\") -" + (ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.selectedBackground()).getLeft() + "px -" + (ListViewDefaultAppearance_ListViewDefaultResources_ie10_kn_IN_InlineClientBundleGenerator.this.selectedBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";border:" + ("1px"+ " " +"dotted"+ " " +"#ddd")  + " !important;cursor:" + ("pointer")  + ";}.GOKTVRVBKCB{background:" + ("none"+ " " +"repeat"+ " " +"scroll"+ " " +"0"+ " " +"50%"+ " " +"#dfe8f6")  + ";border:" + ("1px"+ " " +"dotted"+ " " +"#a3bae9")  + " !important;cursor:" + ("pointer")  + ";}");
      }
