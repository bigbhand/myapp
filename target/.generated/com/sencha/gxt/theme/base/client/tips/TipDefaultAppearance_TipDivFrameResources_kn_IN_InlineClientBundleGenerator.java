...
public class TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator implements com.sencha.gxt.theme.base.client.tips.TipDefaultAppearance.TipDivFrameResources {
  private static TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator _instance0 = new TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.base.client.tips.TipDefaultAppearance.TipNestedDivFrameStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOKTVRVBOKB{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GOKTVRVBNKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBELB{height:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-right:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBDLB{height:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GOKTVRVBFLB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-left:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GOKTVRVBLKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-right:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBKKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBMKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("left"+ " " +"bottom")  + ";padding-left:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBPKB{width:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-right:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBCLB{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("left"+ " " +"0")  + ";padding-left:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBNKB{height:" + ("100%")  + ";}")) : ((".GOKTVRVBOKB{position:" + ("relative")  + ";outline:" + ("none")  + ";}.GOKTVRVBNKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBELB{height:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getHeight() + "px")  + ";width:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:") + (("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topLeftBorder()).getTop() + "px  no-repeat")  + ";padding-left:" + (topLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBDLB{height:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topBorder()).getTop() + "px  repeat-x")  + ";width:" + ("auto")  + ";}.GOKTVRVBFLB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.topRightBorder()).getTop() + "px  repeat") ) + (";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"0")  + ";zoom:" + ("1")  + ";padding-right:" + (topRightBorder().getWidth() + "px")  + ";width:" + ("auto")  + ";}.GOKTVRVBLKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomLeftBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";width:" + ("auto")  + ";background-position:" + ("0"+ " " +"bottom")  + ";padding-left:") + ((bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBKKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomBorder()).getTop() + "px  repeat")  + ";background-position:" + ("0"+ " " +"bottom")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";overflow:" + ("visible")  + ";height:" + (bottomBorder().getHeight() + "px") ) + (";line-height:" + ("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBMKB{overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.bottomRightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("no-repeat")  + ";background-position:" + ("right"+ " " +"bottom")  + ";padding-right:" + (bottomRightBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";line-height:") + (("1px")  + ";font-size:" + ("1px")  + ";}.GOKTVRVBPKB{width:" + ((TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.leftBorder()).getTop() + "px  repeat-y")  + ";padding-left:" + (bottomLeftBorder().getWidth() + "px")  + ";zoom:" + ("1")  + ";overflow:" + ("visible")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";}.GOKTVRVBCLB{overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getSafeUri().asString() + "\") -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getLeft() + "px -" + (TipDefaultAppearance_TipDivFrameResources_kn_IN_InlineClientBundleGenerator.this.rightBorder()).getTop() + "px  repeat")  + ";background-repeat:" + ("repeat-y")  + ";background-position:" + ("right"+ " " +"0")  + ";padding-right:" + (rightBorder().getWidth() + "px")  + ";overflow:" + ("visible")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";}.GOKTVRVBNKB{height:" + ("100%")  + ";}"));
      }
